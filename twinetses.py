...
url = 'https://t.me/dead_webs'  
webbrowser.open(url)  

ascii_banner = pyfiglet.figlet_format("Twinet sessions snoser")  
colored_banner = colored(ascii_banner, color='blue')  
print(colored_banner)
print(colored(f" кодер @losstyy_7 // проект @dead_webs", 'white'))  

number = int(input("Введите номер телефона: "))
count = int(input("Введите количество кругов (1 круг - 12 сообщений):"))
...
try:
    for _ in range(40):  
        ...
        print(colored(f"Всего циклов отправлено: {count} ", 'cyan'))        
